# Contributing to platform_detect
...
[open an issue](https://github.com/Workiva/platform_detect/issues/new) and fill out
...
Please contact us on Slack or [create a JIRA ticket](https://jira.atl.workiva.net/secure/CreateIssue!default.jspa?pid=CPLAT&component=platform_detect)
and fill out the description with as much detail as necessary.

## Contributing Changes
If you're contributing a change to platform_detect, please follow this process: (and
thank you!)
